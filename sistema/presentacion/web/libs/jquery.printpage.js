...
(function( $ ){
  $.fn.printPage = function(options) {
    ...
    // this.on("click", function(){  loadPrintDocument(this, pluginOptions); return false;  });
	 ...
	 // this.imprimir = loadPrintDocument();
    /**
     * Load & show message box, call iframe
     * @param {jQuery} el - The button calling the plugin
     * @param {Object} pluginOptions - options for this print button
     */   
    // this.imprimir = function loadPrintDocument(el, pluginOptions){
      $("body").append(components.messageBox(pluginOptions.message));
      $("#printMessageBox").css("visibility", 'hidden');
	  var el = $('body');
      $("#printMessageBox").animate({visibility:'visible'}, 300, function() { addIframeToPage(el, pluginOptions); });
    // };
    /**
    ...
    function unloadMessage(){
      $("#printMessageBox").delay(1000).animate({visibililty:'hidden'}, 700, function(){
        $(this).remove();
      });
    }
