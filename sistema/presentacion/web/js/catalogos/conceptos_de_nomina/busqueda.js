var BusquedaConceptos_de_nomina=function(){
	...
	this.configurarGrid=function(tabId){
		...
		var dataSource = new wijdatasource({
			...
			loading : function(data){				
				...
				data.proxy.options.data.filtering.push({
					dataKey: "nombre_unidad_de_medida",
					filterOperator: "Contains",
					filterValue: value
				});
		
				data.proxy.options.data.filtering.push({
					dataKey: "nombre_concepto_para_nomina",
					filterOperator: "Contains",
					filterValue: value
				});
...
{ dataKey: "unidad", visible:true, headerText: "Unidad" },
{ dataKey: "nombre_fk_um", visible:true, headerText: "UM" },
