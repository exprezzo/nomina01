var EdicionDepartamentos = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Departamento';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿Eliminar Departamento ?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Departamento: ' + getValorCampo('nombre'));
		}else{
