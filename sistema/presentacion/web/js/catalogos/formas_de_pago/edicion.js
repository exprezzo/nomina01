var EdicionFormas_de_pago = function(){
	this.editado=false;
	this.tituloNuevo='NuevaForma de Pago';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿Eliminar Forma de Pago?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Forma de Pago: ' + getValorCampo('nombre') + ''); 
		}else{
