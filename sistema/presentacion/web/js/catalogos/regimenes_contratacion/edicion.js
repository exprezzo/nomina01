var EdicionRegimenes_contratacion = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Regimen de contratación';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿Eliminar Régimen de Contratación ?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Régimen de Contratacion: ' + getValorCampo('nombre'));
		}else{
