var BusquedaConceptos_para_nomina=function(){
	...
	this.configurarGrid=function(tabId){
		...
		var dataSource = new wijdatasource({
			...
			loading : function(data){				
				...
				data.proxy.options.data.filtering.push({
					dataKey: "abreviacion_unidad_de_medida",
					filterOperator: "Contains",
					filterValue: value
				});
...
{ dataKey: "abreviacion_fk_unidad", visible:true, headerText: "UM" },
{ dataKey: "fk_unidad", visible:false, headerText: "UM" },
			]
		});
