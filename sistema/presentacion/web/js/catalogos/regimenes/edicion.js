var EdicionRegimenes = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Regimen Fiscal';
	...
	this.setDSFk_razon_social = function(){		
		...
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/regimenes/buscarEmpresa',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Regimen Fiscal: ' + getValorCampo('regimen'));
		}else{
