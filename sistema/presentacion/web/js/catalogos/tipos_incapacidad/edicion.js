var EdicionTipos_incapacidad = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Tipo De Incapacidad';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿Eliminar Tipo De Incapacidad?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Tipo De Incapacidad: ' + getValorCampo('descripcion'));
		}else{
