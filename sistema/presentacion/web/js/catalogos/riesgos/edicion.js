var EdicionRiesgos = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Riesgo Puesto';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿Eliminar Riesgo?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Nuevo Riesgo: ' + getValorCampo('descripcion'));
		}else{
