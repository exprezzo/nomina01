var Regimen_fiscalDeEmpresa=function (){	
	...
	this.init=function(config){
		...
		var me = this;
		$(this.tabId + "-dialog-confirm-eliminar-regimen").wijdialog({
			autoOpen: false,
            captionButtons: {                  
				pin: { visible: false },
	...
	this.configurarGrid=function(targetSelector, articulos){		
		...
		gridElementos.bind('keydown', function(e) {
			...
			if(e.keyCode==46 && e.shiftKey){
				...
				$(me.tabId + "-dialog-confirm-eliminar-regimen").wijdialog('open');
			}
		});
		...
		gridElementos.wijgrid({
			...
			columns: [
				...
				{ dataKey: "fk_razon_social", visible:false, headerText: "Fk_razon_social" }
			]
		});
		var me=this;
