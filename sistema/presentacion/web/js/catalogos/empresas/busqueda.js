...
{ dataKey: "nombre_comercial", visible:true, headerText: "Nombre Comercial" },
{ dataKey: "datos_de_contacto", visible:true, headerText: "Datos de Contacto" },
{ dataKey: "logo_factura", visible:true, headerText: "Logotipo" },
{ dataKey: "nombre_fk_pais", visible:true, headerText: "Pais" },
{ dataKey: "fk_pais", visible:false, headerText: "Pais" },
{ dataKey: "nombre_fk_estado", visible:true, headerText: "Fk_estado" },
{ dataKey: "fk_estado", visible:false, headerText: "Fk_estado" },
{ dataKey: "fk_ciudad", visible:false, headerText: "Fk_ciudad" },
{ dataKey: "nombre_fk_municipio", visible:true, headerText: "Fk_municipio" },
{ dataKey: "fk_municipio", visible:false, headerText: "Fk_municipio" },
{ dataKey: "calle", visible:true, headerText: "Calle" },
{ dataKey: "noExterior", visible:true, headerText: "No Exterior" },
{ dataKey: "noInterior", visible:true, headerText: "No Interior" },
...
{ dataKey: "email_bcc", visible:true, headerText: "Email" },
{ dataKey: "RegistroPatronal", visible:true, headerText: "Registro Patronal" },
			]
		});
