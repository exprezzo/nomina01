var EdicionSeries_nomina = function(){
	this.editado=false;
	this.tituloNuevo='Nueva Serie Para Nomina';
	...
	this.setDSFk_razon_social = function(){		
		...
		var proxy = new wijhttpproxy({
			url: kore.url_base+kore.modulo+'/series_nomina/buscarEmpresa',
			dataType: "json", 
			type:"POST",
			data: {
				style: "full",
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Serie Para Nomina: ' + getValorCampo('serie'));
		}else{
