var BusquedaCertificados=function(){
		...
		var dataSource = new wijdatasource({
			...
			loading : function(data){				
				...
				data.proxy.options.data.filtering.push({
					dataKey: "nombre_comercial_empresa",
				...
				data.proxy.options.data.filtering.push({
					dataKey: "valido_desde",
					filterOperator: "Contains",
					filterValue: value
				});
		
				data.proxy.options.data.filtering.push({
					dataKey: "valido_hasta",
					filterOperator: "Contains",
					filterValue: value
				});
...
{ dataKey: "nombre_comercial_fk_razon_social", visible:true, headerText: "Razon Social" },
{ dataKey: "fk_razon_social", visible:false, headerText: "Razon Social" },
{ dataKey: "no_serie", visible:true, headerText: "No Serie" },
{ dataKey: "cer_pem", visible:false, headerText: "Cer_pem" },
{ dataKey: "key_pem", visible:false, headerText: "Key_pem" },
{ dataKey: "pass", visible:true, headerText: "Pass" },
{ dataKey: "valido_desde", visible:true, headerText: "Valido Desde" },
{ dataKey: "valido_hasta", visible:true, headerText: "Valido Hasta" },
{ dataKey: "es_default", visible:true, headerText: "Es Default" },
			]
		});
