var BusquedaImpuestos=function(){
	...
	this.configurarGrid=function(tabId){
		...
		var dataSource = new wijdatasource({
			...
			loading : function(data){				
				...
				data.proxy.options.data.filtering.push({
					dataKey: "nombre_tipo_de_impuesto",
					filterOperator: "Contains",
					filterValue: value
				});
...
{ dataKey: "tasa", visible:true, headerText: "Tasa" },
{ dataKey: "nombre_fk_naturaleza", visible:true, headerText: "Naturaleza" },
{ dataKey: "fk_naturaleza", visible:false, headerText: "Naturaleza" },
{ dataKey: "detalles", visible:true, headerText: "Detalles" },
			]
		});
