var EdicionTipos_de_impuesto = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Tipo De Impuesto';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿Eliminar Tipo De Impuesto?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Tipo De Impuesto: ' + getValorCampo('nombre') + ''); 
		}else{
