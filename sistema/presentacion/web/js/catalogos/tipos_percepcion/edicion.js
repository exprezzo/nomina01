var EdicionTipos_percepcion = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Tipo de Percepción';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿Eliminar Tipo de Percepción?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Tipo de Percepcion: ' + getValorCampo('descripcion'));
		}else{
