var BusquedaMetodos_de_pago=function(){
	...
	this.configurarToolbar=function(tabId){
		...
		$(this.tabId + ' .toolbarEdicion .btnEliminar').click( function(){
			...
			var r=confirm("¿Eliminar Método De Pago?");
			if (r==true){
			  me.eliminar();
			}
		});
...
{ dataKey: "es_pago_con_tarjeta", visible:true, headerText: "Es_pago_con_tarjeta" },
			]
		});
