var EdicionPeriodo_pagos = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Periodo de Pago';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿Eliminar Periodo de Pago?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Periodo de Pago: ' + getValorCampo('descripcion'));
		}else{
