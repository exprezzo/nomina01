var EdicionMonedas = function(){
	this.editado=false;
	this.tituloNuevo='Nueva Moneda';
	this.saveAndClose=false;
	
	
	this.borrar=function(){		
		var r=confirm("¿Eliminar Moneda?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Moneda: ' + getValorCampo('moneda') + ' (' + getValorCampo('codigo') + ')'); 
		}else{
