...
<script>			
	$( function(){	
		...
		var config={
		 ...
		 var editor=new EdicionMetodos_de_pago();
		 editor.init(config);	
		//-----
	...
	<div id="cuerpo">
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_es_pago_con_tarjeta" style=""  >
					<label style="">Es_pago_con_tarjeta:</label>
					<input title="Es_pago_con_tarjeta" type="text" name="es_pago_con_tarjeta" class="entradaDatos" value="<?php echo $this->datos['es_pago_con_tarjeta']; ?>" style="width:500px;" />
				</div>
			</form>
