...
<script>			
	$( function(){	
		...
		var config={
		 ...
		 var editor=new EdicionRegimenes();
		 editor.init(config);	
		//-----
	...
	<div id="cuerpo">
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_regimen" style=""  >
					<label style="">Regimen:</label>
					<input title="Regimen" type="text" name="regimen" class="entradaDatos" value="<?php echo $this->datos['regimen']; ?>" style="width:500px;" />
				</div>
