		...
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_codigo" style=""  >
					...
					<input title="Codigo" type="text" name="codigo" class="entradaDatos" value="<?php echo $this->datos['codigo']; ?>" style="width:500px;" />
				</div>
				<div class="inputBox contenedor_moneda" style=""  >
					<label style="">Moneda:</label>
					<input title="Moneda" type="text" name="moneda" class="entradaDatos" value="<?php echo $this->datos['moneda']; ?>" style="width:500px;" />
				</div>
