...
require_once $_PETICION->basePath.'/presentacion/html.php/conceptos_de_nomina/concepto_de_nomina_pdf.php';
...
class conceptos_de_nomina extends Controlador{
	var $modelo="concepto_de_nomina";	
		...
		function buscarConcepto_para_nomina(){
			$concepto_para_nominaMod= new concepto_para_nominaModelo();
			$res = $concepto_para_nominaMod->buscar( array() );
			echo json_encode( $res );
		}
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new Concepto_de_nominaPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
