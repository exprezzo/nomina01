...
require_once $_PETICION->basePath.'/presentacion/html.php/tipos_de_impuesto/tipo_de_impuesto_pdf.php';

class tipos_de_impuesto extends Controlador{
	var $modelo="tipo_de_impuesto";	
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new Tipo_de_impuestoPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
