...
require_once $_PETICION->basePath.'/modelos/tipo_percepcion.php';

class percepciones_nomina extends Controlador{
	var $modelo="percepcion_nomina";	
	
	
		function buscarTipo_percepcion(){
			$tipo_percepcionMod= new tipo_percepcionModelo();
			$res = $tipo_percepcionMod->buscar( array() );
