...
require_once $_PETICION->basePath.'/modelos/tipo_hora.php';

class horas_extra_nomina extends Controlador{
	var $modelo="hora_extra_nomina";	
	
	
		function buscarTipo_hora(){
			$tipo_horaMod= new tipo_horaModelo();
			$res = $tipo_horaMod->buscar( array() );
