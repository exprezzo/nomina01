...
require_once $_PETICION->basePath.'/modelos/tipo_deduccion.php';

class deducciones_nomina extends Controlador{
	var $modelo="deduccion_nomina";	
	
	
		function buscarTipo_deduccion(){
			$tipo_deduccionMod= new tipo_deduccionModelo();
			$res = $tipo_deduccionMod->buscar( array() );
