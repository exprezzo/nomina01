...
require_once $_PETICION->basePath.'/presentacion/html.php/metodos_de_pago/metodo_de_pago_pdf.php';

class metodos_de_pago extends Controlador{
	var $modelo="metodo_de_pago";	
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new Metodo_de_pagoPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
