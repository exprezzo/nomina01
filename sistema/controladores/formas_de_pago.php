...
require_once $_PETICION->basePath.'/presentacion/html.php/formas_de_pago/forma_de_pago_pdf.php';

class formas_de_pago extends Controlador{
	var $modelo="forma_de_pago";	
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new Forma_de_pagoPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
