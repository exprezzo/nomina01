...
require_once $_PETICION->basePath.'/modelos/tipo_incapacidad.php';

class incapacidades extends Controlador{
	var $modelo="incapacidad";	
	
	
		function buscarTipo_incapacidad(){
			$tipo_incapacidadMod= new tipo_incapacidadModelo();
			$res = $tipo_incapacidadMod->buscar( array() );
